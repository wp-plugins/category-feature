...
The Featured Category Widget is mainly designed because there were peole for whom the Featured Post Widget was not enough. They wanted to put a category of their blog in the hoghlight.
...
1. Upload the `category-feature-widget` folder to the `/wp-content/plugins/` directory
